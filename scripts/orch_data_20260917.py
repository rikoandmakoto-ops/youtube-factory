#!/usr/bin/env python3
"""2026-09-17 指揮者: analytics.db から xlsx 用のデータを全部出す（集計は1箇所に集約）。"""
...
out['within_ch']={}
for snapd in ['2026-09-08','2026-09-13','2026-09-14','2026-09-15','2026-09-16']:
    res={}
    for ch in ACT5:
...
json.dump(out,open('reports/_orch_20260917_data.json','w'),ensure_ascii=False,indent=1)
