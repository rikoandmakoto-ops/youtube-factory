...
- 構成(6行固定):
  ...
  6行目=**関連動画誘導CTA(必須・絶対省略禁止)**: 「もっと詳しい理由は、関連動画から見てね!」「全部の答えは関連動画にあるよ!」「気になる人は関連動画でチェック!」のように、必ず「関連動画」というワードを含める。ショートからの離脱者を長尺へ送る最重要導線のため、「本編」より「関連動画」を優先する。
...
- 構成(6行固定):
  ...
  6行目=**関連動画誘導CTA(必須・絶対省略禁止)**: 「もっと詳しい話は関連動画で語っている」「全貌は関連動画にて」「気になる人は関連動画をチェック」のように、必ず「関連動画」というワードを含める。ショートからの離脱者を長尺へ送る最重要導線のため、「本編」より「関連動画」を優先する。
