#!/usr/bin/env python3
"""daily-scienceチャンネルでテーマ指定して動画を1本生成するスクリプト

run_daily_science.py が theme_seeds 不在で suggest_themes を叩いてしまう問題を回避するため、
theme_override を直接渡す版。
"""
